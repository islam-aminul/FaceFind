      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Assigned Events</h3>
            <p className="text-3xl font-bold text-gray-900 mt-2">0</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Photos Uploaded</h3>
            <p className="text-3xl font-bold text-gray-900 mt-2">0</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-3xl font-bold text-gray-900 mt-2">0 GB</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-sm">You'll see your event assignments here</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">View assigned events</p>
            </Link>
